...
{#snippet clockStage(count: number, index: number, title: string, divider = true)}
  <div class="flex flex-col items-center gap-2">
    <div class="card h-11 overflow-hidden rounded-xl bg-muted font-mono text-xl ring ring-foreground/25 drop-shadow-md">
      <div
  ...
  {:else}
    <p class="invisible hidden text-center text-lg font-semibold text-muted-foreground md:visible md:block"></p>
  {/if}
{/snippet}
