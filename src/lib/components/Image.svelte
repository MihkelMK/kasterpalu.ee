...
{#if image}
  <div class="projectCardImage grid justify-items-center overflow-hidden rounded-md bg-primary shadow-lg">
    {#if typeof image.src === 'string'}
      <img src={image.src} alt={image.alt} class={className} {loading} {fetchpriority} {sizes} />
    {:else}
      <enhanced:img src={image.src} alt={image.alt} class={className} {loading} {fetchpriority} {sizes} />
    {/if}
    {#if tags}
