        ...
        <Pagination.Content class="flex items-center">
          <Pagination.Item>
            <Pagination.PrevButton
              class="hover:bg-dark-10 inline-flex size-6 items-center justify-center rounded-lg bg-transparent active:scale-98 disabled:cursor-not-allowed disabled:text-muted-foreground hover:disabled:bg-transparent sm:size-10 md:mr-4">
          ...
          <Pagination.Item>
            <Pagination.NextButton
              class="hover:bg-dark-10 inline-flex size-6 items-center justify-center rounded-lg bg-transparent active:scale-98 disabled:cursor-not-allowed disabled:text-muted-foreground hover:disabled:bg-transparent sm:size-10 md:ml-4">
